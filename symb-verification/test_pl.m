...
syms alpha rho n L mu tau C;
syms clambda cgamma ceta;

zero = sym(0);
one = sym(1);

clambda = sym(1)/sym(200000);
cgamma = sym(12)/sym(200000);
ceta = sym(1)/sym(100000000);

c = [sym(0.0040); sym(0.000065); sym(0.05); sym(0.0000025); sym(2); sym(0.000005)];
...
M = param_matrix_pl(lambda, gamma, eta, n, L, L, alpha, rho, C);
